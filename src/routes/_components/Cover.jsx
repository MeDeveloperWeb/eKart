...
export default function Cover() {
  const BigCoverText = ({ className, ...props }) => (
    <>
      {/*for xl and bigger */}
      <div
        className={`absolute my-10 hidden h-screen w-full grid-cols-2 grid-rows-2 font-cover text-[20vw] *:py-4 xl:grid ${className}`}
        {...props}
      >
  ...
  return (
    <div className="-mt-[4.25rem] flex w-full justify-center overflow-hidden bg-bisque dark:bg-[#562f00]">
      ...
      <div className="-z-5 flex min-h-screen w-full flex-col pt-24 lg:pt-0">
        <div className="sticky top-0 max-h-[80vh] xl:max-h-screen">
          <img src={model1} alt="Cover photo 2" className="mx-auto my-0" />
        </div>
